...
namespace restoran
{
    public partial class PICE : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (textBox1.Text == "RAKIJA")
                b = 200;
            else if (textBox1.Text == "VINjAK")
                b = 250;
            else if (textBox1.Text == "VODKA")
                b = 260;
            else
                b = 0;
            ...
            g = new Gost(o.Ime, c);
            g.UpisiRacun(textBox1.Text, textBox3.Text, g.Ime);
        }
